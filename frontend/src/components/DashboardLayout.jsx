  ...
  export default function DashboardLayout() {
    ...
    const handleLogout = async () => {
      try {
        ...
        logout(); // Clear the local user state
      ...
      <div className="min-h-screen bg-gray-100">
        ...
        <header className="fixed top-0 left-0 right-0 z-40 bg-white shadow-md h-14 flex items-center justify-between px-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button  onClick={handleLogout} className="text-sm bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600 flex items-center space-x-1">
              <LogOut size={16} />
              <span>Logout</span>
            </button>
          </div>
